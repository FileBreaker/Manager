...
public class ExperimentJDialog extends javax.swing.JDialog {
     ...
     */
    public ExperimentJDialog(java.awt.Frame parent, boolean modal, MainController mainController, ExperimentsFrameView experimentsFrameView) {
        super(parent, modal);
     ...
     * @param experimentsFrameView 
     */
    public ExperimentJDialog(java.awt.Frame parent, boolean modal, MainController mainController, ExperimentsFrameView experimentsFrameView, Experiment experiment) {
        super(parent, modal);
    ...
    private void createExperimentActionPerformed(ActionEvent evt) {
		...
		if(experiment == null){
			...
			mainController.editExperiment(experiment);
		}
