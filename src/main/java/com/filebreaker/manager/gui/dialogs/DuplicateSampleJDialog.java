...
public class DuplicateSampleJDialog extends javax.swing.JDialog {
     ...
     */
    public DuplicateSampleJDialog(java.awt.Frame parent, boolean modal, MainController mainController, Integer sampleId, Integer experimentId) {
        super(parent, modal);
    ...
    private void duplicateSampleActionPerformed(ActionEvent evt) {
		...
		if(samplesNumber > 0){
			mainController.duplicateSamples(sampleId, experimentId, samplesNumber);
