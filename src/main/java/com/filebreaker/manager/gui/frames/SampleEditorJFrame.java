...
public class SampleEditorJFrame extends javax.swing.JFrame {
	...
	public SampleEditorJFrame(MainController mainController, Integer experimentId) {
    ...
    public SampleEditorJFrame(MainController mainController, Integer experimentId, Integer selectedSampleId) {
		this(mainController, experimentId);
